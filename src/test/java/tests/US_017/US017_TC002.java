...
public class US017_TC002 {
    ...
    public void US017_TC002() throws InterruptedException {
        ...
        c4PearlyMarketPage.fistNameShipping.sendKeys("Erol");
        actions.sendKeys(Keys.TAB).sendKeys("Evren").sendKeys(Keys.TAB).sendKeys(Keys.TAB).sendKeys("Turkey").sendKeys(Keys.TAB).sendKeys("Selenium cook kolay Street ").
                sendKeys(Keys.TAB).sendKeys(Keys.TAB).sendKeys("190523").sendKeys(Keys.TAB).sendKeys("Galatasaray").sendKeys(Keys.TAB).sendKeys("İstanbul").perform();
